  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        ...
        institutional: "bg-otti-teal text-otti-cream border-2 border-otti-copper hover:bg-otti-teal/90 shadow-lg",
        estate: "bg-otti-copper text-white rounded-none px-10 hover:bg-otti-copper/90 tracking-[0.1em] uppercase",
        hub: "bg-otti-sky/10 text-otti-teal border border-otti-sky/30 hover:bg-otti-sky/20 rounded-full",
      },
      size: {
        default: "h-11 px-6",
